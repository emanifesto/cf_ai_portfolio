...
export function ExperienceL() {
    ...
    return (
        <div className="max-w-[90%] w-[90%] lg:w-[75%] -mt-10 font-semibold">
            ...
            <Card title={<HighlightBlue>Software Engineer & Founder</HighlightBlue>}
            ...
            <Card title={<HighlightRed>Java Supplemental Instructor</HighlightRed>}
            ...
            <Card
                title={<HighlightBlue>AI/ML Researcher</HighlightBlue>}
