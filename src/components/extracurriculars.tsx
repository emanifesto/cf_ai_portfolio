...
export function ExtracurricularsL() {
    ...
    return (
        <div className="max-w-[90%] w-[90%] lg:w-[75%] -mt-10 font-semibold">
            ...
            <Card
                title={<HighlightRed size='text-xl text-3xl'>Presentations</HighlightRed>}
            ...
            <Card
                title={<HighlightBlue size='text-xl text-3xl'>Piano</HighlightBlue>}
                isOpen={expanded === 3} isHidden={expanded !== null && expanded !== 3}
                onClick={() => toggle(3)}
            >
                <li>Got the opportunity to perform on a Steinway Grand Piano in front of a few people for a piano recital.</li>
            </Card>
