...
export function InnerContainer({view, id, Left, Right }: {view: string, id: string, Left: ReactNode, Right: ReactNode }) {
    return (
        <div id={id} className={`${view !== id && "opacity-0 invisible"} flex fixed flex-col-reverse lg:flex-row top-0 left-0 transition-opacity duration-800 w-full h-screen overflow-hidden`}>
