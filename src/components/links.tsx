...
export default function Links() {
    return (
        <div className='flex items-center gap-4 fixed z-1 bottom-4 left-[50%] translate-x-[-50%]'>
            <div className='dark:bg-gray-400 bg-gray-700 fixed -left-2 lg:-left-5 -translate-x-full h-0.5 w-5  '></div>
            <div className='dark:bg-gray-400 bg-gray-700 fixed -right-2 lg:-right-5 translate-x-full h-0.5 w-5 '></div>
