...
export function HomeL(){
    return(
        <div className="tracking-wide text-center max-w-[90%] font-semibold px-4 py-10 rounded-xl bg-linear-to-tr from-white/30 to-white/10 shadow-sm shadow-white">
            <p>
                Hello, I'm <Bold>Emmanuel Babayemi.</Bold> A Software Developer with a specialization in 
